...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the DogecoinEV Core repository on GitHub"),
        tr("Services that claim to double your dogecoinevs are always ponzi schemes")
    };
