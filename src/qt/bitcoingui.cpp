    ...
    platformStyle(_platformStyle)
{
    ...
    // DogecoinEV: load fallback font in case Monospace is not available on the system
    QFontDatabase::addApplicationFont(":fonts/RobotoMono-Bold");
    QFont::insertSubstitution("Monospace", "RobotoMono");

    // DogecoinEV: Specify Monospace as new font.
    QFont newFont("Monospace", 10);

    // DogecoinEV: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DogecoinEV address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dogecoinev: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DogecoinEV addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DogecoinEV addresses"));
    ...
    openAction->setStatusTip(tr("Open a dogecoinev: URI or payment request"));

    importPrivateKeyAction = new QAction(platformStyle->TextColorIcon(":/icons/address-book"), tr("&Import Private Key..."), this);
    importPrivateKeyAction->setStatusTip(tr("Import a DogecoinEV private key"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible DogecoinEV command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to DogecoinEV network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("DogecoinEV"); // default title
