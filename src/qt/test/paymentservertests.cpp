...
void PaymentServerTests::paymentServerTests()
{
    ...
    // DogecoinEV: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for DogecoinEV (as there is no actual maximum coins)
