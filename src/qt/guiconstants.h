...
#define QAPP_ORG_NAME "DogecoinEV"
#define QAPP_ORG_DOMAIN "dogecoinev.org"
#define QAPP_APP_NAME_DEFAULT "DogecoinEV-Qt"
#define QAPP_APP_NAME_TESTNET "DogecoinEV-Qt-testnet"
