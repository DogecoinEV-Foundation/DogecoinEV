...
/* Dogecoin 1.14.5: set the wallet's discard threshold to 1 ELON because that's what 97%
 ...
 */
/* Dogecoin 1.14.6: set the wallet's discard threshold to 0.01 ELON. Very network
...
/*
 * DogecoinEV: Scaled to 1/10th of the recommended transaction fee to make RBF
...
/*
 * DogecoinEV: Creating change outputs at exactly the dustlimit is counter-
...
public:
    ...
    /**
     * DogecoinEV: Get a fee targetting a specific transaction speed.
     */
    CAmount GetDogecoinEVPriorityFee(const CMutableTransaction& tx, unsigned int nTxBytes, FeeRatePreset nSpeed);
    /**
     * DogecoinEV: Get a fee targetting a specific transaction speed.
     */
    static CAmount GetDogecoinEVPriorityFee(const CMutableTransaction& tx, unsigned int nTxBytes, FeeRatePreset nSpeed, CAmount targetFee);
    /**
    ...
    /**
     * Return the minimum required fee taking into account the
     * floating relay fee and user set minimum transaction fee, but not the DogecoinEV dust fee.
     */
