...
void Shutdown()
{
    ...
    RenameThread("dogecoinev-shutoff");
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-mineraddress=<addr>", _("Specify address for miner block rewards (default: wallet address)"));
    if (showDebug)
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/dogecoinevppc/dogecoinev>";
    const std::string URL_WEBSITE = "<https://dogecoinev.org>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("dogecoinev-loadblk");
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("DogecoinEV version %s\n", FormatFullVersion());
}
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // DogecoinEV: Do we need to do any RPC mining init here?
