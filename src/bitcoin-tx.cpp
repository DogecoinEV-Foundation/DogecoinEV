...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s dogecoinev-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dogecoinev-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dogecoinev transaction") + "\n" +
              "  dogecoinev-tx [options] -create [commands]   " + _("Create hex-encoded dogecoinev transaction") + "\n" +
              "\n";
