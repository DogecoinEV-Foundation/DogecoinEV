 ...
 *
 *  DogecoinEV:    Increment mempool limits and accept RBF in steps of 0.0001 ELON
...
/**
 * DogecoinEV: Default dust limit that is evaluated when considering whether a
...
/**
 * DogecoinEV: Default hard dust limit that is evaluated when considering whether
