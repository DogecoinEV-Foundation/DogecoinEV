# Contributing to DogecoinEV Core

DogecoinEV Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/dogecoinevppc/dogecoinev/labels/help%20wanted)
* [Projects](https://github.com/dogecoinevppc/dogecoinev/projects)
* [DogecoinEVdev on reddit](https://www.reddit.com/r/dogecoinevdev/)

## Branch Strategy

DogecoinEV Core's default branch is intentionally a stable release, so that anyone
...
DogecoinEV Core is a direct fork of Bitcoin Core and therefore benefits from as
...
[bitcoin/bitcoin](https://github.com/bitcoin/bitcoin) and future DogecoinEV Core
releases will automatically benefit from these.

When refactoring DogecoinEV-specific code, please keep refactoring requests short,
...
The following applies to code changes to DogecoinEV Core, and is not to be
confused with overall DogecoinEV Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into DogecoinEV Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of DogecoinEV; meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards DogecoinEV
(over time) or have clear domain expertise may naturally have more weight, as
one would expect in all walks of life.

Where a patch set proposes to change the DogecoinEV consensus, it must have been
